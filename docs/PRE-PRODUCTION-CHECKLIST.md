...
6. [ ] Tek süper admin rolünü doğrulayın; eski kısa parolanın e-posta kurtarma akışıyla değiştirilebildiğini doğrulayın. Bootstrap komutunu parola sıfırlamak için kullanmayın.
